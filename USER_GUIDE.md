...
**Sarah's Story:**
Sarah is a 22-year-old college student who wants to lose 5kg in 3 months.
...
4. Click "Create Account" → Redirected to login
...
1. Go to "Meals" page
2. Click "Add a New Meal" → Select "Breakfast"
3. Search for "Oatmeal" → Click to add
4. Enter quantity: 1 serving
5. Repeat for Lunch, Dinner, Snacks
6. Go to Dashboard to see daily totals
...
3. View 7-day nutrition history table
...
**Mike's Story:**
Mike is a 28-year-old fitness enthusiast focused on muscle gain.
...
**Emma's Story:**
Emma is a 35-year-old professional who wants to maintain her weight and stay healthy.
...
1. **Morning**: Open app, set meals for day
2. **After Meals**: Log immediately
3. **Evening**: Review totals
